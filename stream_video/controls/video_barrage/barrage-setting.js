...
function showBarrageSettingBoard() {
    ...
    window.fadeIn(barrageSettingBoard, videoControlsDuration, barrageSettingContainer).then(() => {
    });
}

function hideBarrageSettingBoard() {
    window.fadeOut(barrageSettingBoard, videoControlsDuration, barrageSettingContainer).then(() => {
...
function showBarrageFontFamilyList() {
    barrageFontFamilyList.classList.add(showClassName);
}
...
function hideBarrageFontFamilyList() {
    barrageFontFamilyList.classList.remove(showClassName);
}
