...
function showVolumeAdjustContainer() {
    window.fadeIn(volumeAdjustContainer, videoControlsDuration, volumeContainer).then(() => {});
}

function hideVolumeAdjustContainer() {
    window.fadeOut(volumeAdjustContainer, videoControlsDuration, volumeContainer).then(() => {});
}
...
function initialVolume() {
    ...
    volumeAdjustContainer.classList.remove(showClassName);
}
